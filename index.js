...
const errorMessage = document.getElementById('error'); // Added errorMessage element
// Here is declarataion variables
let targetNumber;
let attempts = 0;
...
// Showing the guess and remaining attempts
  ...
  if (attempts === maxNumberOfAttempts) { // removed extra '='
    submitButton.disabled = true;
    guessInput.disabled = true;
  }
